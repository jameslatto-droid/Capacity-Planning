...
import { BarChart, Bar, XAxis as _XAxis, YAxis as _YAxis, CartesianGrid, Tooltip, ResponsiveContainer, } from 'recharts';
...
var DashboardPage = function () {
    useEffect(function () { LOG('DashboardPage mounted — recharts rendering'); }, []);
    return (React.createElement("div", null,
        ...
        React.createElement("div", { style: { height: 240 } },
            React.createElement(ResponsiveContainer, { width: "100%", height: "100%" },
                React.createElement(BarChart, { data: CHART_DATA, margin: { top: 4, right: 8, left: -16, bottom: 0 } },
                    ...
                    React.createElement(Tooltip, { contentStyle: { background: '#1e293b', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 8, color: '#fff' } }),
                    React.createElement(Bar, { dataKey: "capacity", fill: "#334155", radius: [3, 3, 0, 0] }),
                    React.createElement(Bar, { dataKey: "allocated", fill: "#ffbd66", radius: [3, 3, 0, 0] })))),
...
var ResourcesPage = function () {
    ...
    useEffect(function () { LOG('ResourcesPage mounted — framer-motion cards active'); }, []);
    return (React.createElement("div", null,
        React.createElement("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 } },
            React.createElement("h3", { style: { color: '#ffbd66', margin: 0 } },
                ...
                resourceCount,
                ")"),
            React.createElement(motion.button, { whileHover: { scale: 1.04 }, whileTap: { scale: 0.96 }, onClick: addResource, style: { background: '#ffbd66', color: '#000', border: 'none', padding: '6px 14px', borderRadius: 6, cursor: 'pointer', fontWeight: 600, fontSize: 13 } }, "+ Add Resource")),
        React.createElement("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 12 } }, RESOURCES.slice(0, resourceCount).map(function (r, i) { return (React.createElement(motion.div, { key: r.id, initial: { opacity: 0, y: 12 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.25, delay: i * 0.04 }, style: { background: '#1e293b', borderRadius: 10, padding: 16, border: '1px solid rgba(255,255,255,0.07)' } },
...
var PlanningPage = function () {
    useEffect(function () { LOG('PlanningPage mounted — table rendered'); }, []);
    var _a = __read(useState(null), 2), hoveredRow = _a[0], setHoveredRow = _a[1];
        ...
        React.createElement("div", { style: { fontFamily: 'Inter, -apple-system, system-ui, sans-serif', background: '#0f172a', minHeight: 440, color: '#e2e8f0', borderRadius: 12, overflow: 'hidden' } },
            ...
            React.createElement("div", { style: { padding: 20 } },
                React.createElement(AnimatePresence, { mode: "wait" },
                    React.createElement(motion.div, { key: activeTab, initial: { opacity: 0, x: 8 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: -8 }, transition: { duration: 0.18 } },
