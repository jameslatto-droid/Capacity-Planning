...
import type { IAppContext } from '../../webparts/capacityPlanner/components/CapacityPlannerApp'
...
interface InnerProps {
  spfxContext?: IAppContext
}

function Inner({ spfxContext }: InnerProps) {
  ...
  return (
    <HashRouter>
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
        <TopBar spfxContext={spfxContext} />
...
export function App({ spfxContext }: AppProps) {
  return (
    <ThemeProvider>
      <BackgroundProvider>
        <AuthProvider>
          <AppBg />
          <Inner spfxContext={spfxContext} />
        </AuthProvider>
      </BackgroundProvider>
    </ThemeProvider>
  )
